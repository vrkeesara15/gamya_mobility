  ...
  Widget _detail(AdhocRequest a) {
    ...
    return DetailPanel(
      ...
      tabViews: [
        ...
        Column(children: [KeyValueRow('Vehicle Type', Fmt.vehicleType(a.vehicleType)), KeyValueRow('No. of Vehicles', '${a.numberOfVehicles}'), KeyValueRow('Estimated Amount', Fmt.inr(a.estimatedAmount)), KeyValueRow('Trip Amount', a.trip == null ? '—' : Fmt.inr((a.trip!['amount'] as num?) ?? a.estimatedAmount)), const SizedBox(height: 8), const Text('Amounts are based on the tariff configured in Settings; the final trip amount can be adjusted when the trip is completed.', style: TextStyle(fontSize: 11.5, color: GamyaColors.textMuted))]),
